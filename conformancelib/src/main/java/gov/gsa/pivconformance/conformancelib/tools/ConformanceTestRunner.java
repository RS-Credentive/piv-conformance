...
public class ConformanceTestRunner {
    ...
    public static void main(String[] args) {
            ...
            while (rs.next()) {
                ...
                for (TestStepModel currentStep : steps) {
                    ...
                    if (parameters != null) {
                        ...
                        if (enableVerboseParameterDebugging)
                            s_logger.debug("processing {} as parameters for {}.{}", parameterString, className,
                                    methodName);
                    }
        ...
        // suiteBuilder.selectors(discoverySelectors);
        // XXX *** TODO: Need to add key/value to each suite so that logging can be
        // fixed up
