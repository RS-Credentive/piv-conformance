...
public class PKIX_X509DataObjectTests {
	...
	void PKIX_Test_2(String oid, TestReporter reporter) { 
		...
		a_actualValueLogger.info("{},{},{},{},{}","  --  ","Key usage extension is present","TRUE",(cert.getKeyUsage() != null),""); 
	}
	...
	void PKIX_Test_4(String oid, TestReporter reporter) {
		...
		a_actualValueLogger.info("{},{},{},{},{}","  --  ","Key usage extension is present","TRUE",(foundBits != null),""); 
		...
		if(oid.compareTo(APDUConstants.X509_CERTIFICATE_FOR_PIV_AUTHENTICATION_OID) == 0){
			a_actualValueLogger.info("{},{},{},{},{}","  --  ","OID compared to X509_CERTIFICATE_FOR_PIV_AUTHENTICATION_OID is equal to 0","TRUE",(oid.compareTo(APDUConstants.X509_CERTIFICATE_FOR_PIV_AUTHENTICATION_OID)),"");
			...
			a_actualValueLogger.info("{},{},{},{},{}","  --  ","OID compared to X509_CERTIFICATE_FOR_DIGITAL_SIGNATURE_OID is equal to 0","TRUE",(oid.compareTo(APDUConstants.X509_CERTIFICATE_FOR_DIGITAL_SIGNATURE_OID)),"");
			assertTrue(foundUsage.hasUsages(KeyUsage.digitalSignature), "digitialSignature is not set");
			...
			a_actualValueLogger.info("{},{},{},{},{}","  --  ","(OID compared to X509_CERTIFICATE_FOR_CARD_AUTHENTICATION_OID is equal to 0","TRUE",(oid.compareTo(APDUConstants.X509_CERTIFICATE_FOR_CARD_AUTHENTICATION_OID)),"");
			assertTrue(foundUsage.hasUsages(KeyUsage.digitalSignature), "digitialSignature is not set");
			assertFalse(foundUsage.hasUsages(KeyUsage.nonRepudiation), "nonRepudiation is set");
			assertFalse(foundUsage.hasUsages(KeyUsage.keyAgreement), "keyAgreement is set");
			assertFalse(foundUsage.hasUsages(KeyUsage.dataEncipherment), "dataEncipherment is set");
			...
			a_actualValueLogger.info("{},{},{},{},{}","  --  ","(OID compared to CARD_HOLDER_UNIQUE_IDENTIFIER_OID is equal to 0","TRUE",(oid.compareTo(APDUConstants.CARD_HOLDER_UNIQUE_IDENTIFIER_OID)),"");
			assertTrue(foundUsage.hasUsages(KeyUsage.digitalSignature), "digitialSignature is not set");
			assertFalse(foundUsage.hasUsages(KeyUsage.nonRepudiation), "nonRepudiation is set");
			assertFalse(foundUsage.hasUsages(KeyUsage.keyAgreement), "keyAgreement is set");
			assertFalse(foundUsage.hasUsages(KeyUsage.dataEncipherment), "dataEncipherment is set");
    ...
    void PKIX_Test_5(String oid, TestReporter reporter) {
		...
		a_actualValueLogger.info("{},{},{},{},{}","  --  ","Certificate policies extension is present","TRUE",(cpex != null),""); 
    }
    ...
    void PKIX_Test_6(String oid, String containersAndPolicyOids, TestReporter reporter) {
		...
		a_actualValueLogger.info("{},{},{},{},{}","  --  ","Certificate readable for " + oid,"TRUE",(eeCert != null),"");
		...
		a_actualValueLogger.info("{},{},{},{},{}","  --  ","Cert valid to trust anchor in default keystore","TRUE",valid,"");
    }
    ...
    void PKIX_Test_8(String oid, TestReporter reporter) {
		...
		a_actualValueLogger.info("{},{},{},{},{}","  --  ","An accessMethod containing " +  X509ObjectIdentifiers.ocspAccessMethod.toString() + " is present","TRUE",rv,"");
	}
	...
	void PKIX_Test_9(String oid, TestReporter reporter) {
		...
		a_actualValueLogger.info("{},{},{},{},{}","  --  ","The accessLocation for this AccessMethod is of type uniformResourceIdentifier","TRUE",rv,"");
	}
    ...
    void PKIX_Test_10(String oid, TestReporter reporter) {
		...
		if (cert != null) {
			...
			a_actualValueLogger.info("{},{},{},{},{}","  --  ","pivInterim extension is present","TRUE",(pivInterim != null),"");

			assertTrue(pivInterim.length > 0, "pivInterim extension is empty");
			a_actualValueLogger.info("{},{},{},{},{}","  --  ","pivInterim extension not empty","TRUE",(pivInterim.length > 0),"");
			a_actualValueLogger.info("{},{},{},{},{}","  --  ","pivInterim extension actual length","--",pivInterim.length,"");
		}
    }
    ...
    void PKIX_Test_12(String oid, String requiredOid, TestReporter reporter) {
		...
		a_actualValueLogger.info("{},{},{},{},{}","  --  ","Certificate contains " + Hex.encodeHexString(fascn),"TRUE",matchFascn(cert, fascn, requiredOid),"");
	}
    ...
    void PKIX_Test_13(String oid, TestReporter reporter) {
		...
		//Confirm that expiration of certificate is not later than expiration of card
				...
				a_actualValueLogger.info("{},{},{},{},{}","  --  ","Certificate " + notAfter + " is not later than " + exactDateTime,"TRUE",(notAfter.compareTo(exactDateTime) <= 0),"");
    }
    ...
    void PKIX_Test_14(String oid, TestReporter reporter) {
		...
		if(pubKey instanceof RSAPublicKey) {
			...
			a_actualValueLogger.info("{},{},{},{},{}","  --  ","Public Exponent is >= 65637","TRUE",(((RSAPublicKey) (pubKey)).getPublicExponent().compareTo(be) >= 0),"");
		} 		
    }
    ...
    void PKIX_Test_18(String oid, String policyOid, TestReporter reporter) {
		...
		a_actualValueLogger.info("{},{},{},{},{}","  --  ","Certificate policy " + policyOid + " is present in certificate policies on certificate","TRUE",containsOOID,""); 
    ...
    void PKIX_Test_21(String oid, String ekuOid, TestReporter reporter) {
		...
		a_actualValueLogger.info("{},{},{},{},{}","  --  ","Certificate policies extension is present","TRUE",(ekuex != null),"");
		...
		a_actualValueLogger.info("{},{},{},{},{}","  --  ","Extended Key Usage contains " + ekuOid,"TRUE",containsOOID,"");
	}
    ...
    void PKIX_Test_25(String oid, TestReporter reporter) {
    	...
    	try {
	        ...
	        assertNotNull(aia);
			a_actualValueLogger.info("{},{},{},{},{}","  --  ","Authority Information Access is NOT NULL","TRUE",(aia != null),"");
    	...
    	if (sd != null) {
			...
			a_actualValueLogger.info("{},{},{},{},{}","  --  ","Message is Certificate Management Message","TRUE",sd.isCertificateManagementMessage(),"");
    ...
    void PKIX_Test_26(String oid, TestReporter reporter) {
		...
		a_actualValueLogger.info("{},{},{},{},{}","  --  ","Signing certificate not expired","TRUE",(cert.getNotAfter().compareTo(today) >= 0),"");
    ...
    void PKIX_Test_27(String oid, String requiredOid, TestReporter reporter) {
		...
		a_actualValueLogger.info("{},{},{},{},{}","  --  ","Certificate contains GUID: " + Hex.encodeHexString(guid),"TRUE",matchUuid(cert, guid),"");
	}
	...
	private static Map<String, X509Certificate> getCertificatesForOids(List<String> oids) {
		...
		a_actualValueLogger.info("{},{},{},{},{}","  --  ","Instance of Card Settings Singleton created","TRUE",(css != null),"");
	...
	void PKIX_Test_29(String oid, TestReporter reporter) {
		...
		assertTrue (rv, "The accessLocation for this AccessMethod is not of type uniformResourceIdentifier.");
		a_actualValueLogger.info("{},{},{},{},{}","  --  ","Access Location is of type Uniform Resource Identifier","TRUE",rv,"");
	}
	...
	void PKIX_Test_31(String oid, TestReporter reporter) {
		...
		a_actualValueLogger.info("{},{},{},{},{}","  --  ","URI scheme for id-ce-cRLDistributionPoints is http:","TRUE",rv,"");
	}
	...
	private static Stream<Arguments> pKIX_x509TestProvider() {
		...
		a_actualValueLogger.info("{},{},{},{},{}","  --  ","Certificate retrived from X509CertificateDataObject object is NOT NULL","TRUE",(cert1 != null),"");
		...
		a_actualValueLogger.info("{},{},{},{},{}","  --  ","Certificate retrived from X509CertificateDataObject object is NOT NULL","TRUE",(cert2 != null),"");
		...
		a_actualValueLogger.info("{},{},{},{},{}","  --  ","Certificate retrived from X509CertificateDataObject object is NOT NULL","TRUE",(cert3 != null),"");
		...
		a_actualValueLogger.info("{},{},{},{},{}","  --  ","Certificate retrived from X509CertificateDataObject object is NOT NULL","TRUE",(cert4 != null),"");
		...
		a_actualValueLogger.info("{},{},{},{},{}","  --  ","Certificate retrived from X509CertificateDataObject object is NOT NULL","TRUE",(cert5 != null),"");
	...
	private static Stream<Arguments> pKIX_x509TestProvider_aia_crldp() {
		...
		for(String oid : certContainersToTest) {
			...
			a_actualValueLogger.info("{},{},{},{},{}","  --  ","Certificate retrived for " + oid,"TRUE",(cert != null),"");
