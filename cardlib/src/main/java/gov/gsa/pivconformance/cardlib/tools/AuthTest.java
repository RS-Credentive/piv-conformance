...
public class AuthTest {
    ...
    public static void main(String[] args) {
        ...
        byte[] select = { (byte) 0x00, (byte) 0xa4, (byte) 0x04, (byte) 0x00, (byte) 0x0B, (byte) 0xa0, 0x00, 0x00,
        ...
        try {
            ...
            s_logger.info("Sent: {} Received: {}", Hex.encodeHexString(sel.getBytes()),
                    Hex.encodeHexString(rspAPDU.getBytes()));
            ResponseAPDU rspAPDU2 = c.transmit(sel);
            s_logger.info("Sent: {} Received: {}", Hex.encodeHexString(sel.getBytes()),
                    Hex.encodeHexString(rspAPDU2.getBytes()));
        } catch (CardException e1) {
            // TODO Auto-generated catch block
            e1.printStackTrace();
        }
        ...
        try {
            ...
            s_logger.info("Sent: {} Received: {}", Hex.encodeHexString(cmd.getBytes()),
                    Hex.encodeHexString(rsp.getBytes()));
        } catch (CardException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        }
