...
public class DefaultPIVApplication extends AbstractPIVApplication {
    ...
    // @Override
    // public MiddlewareStatus pivPutData(CardHandle cardHandle, String OID,
    // PIVDataObject data) {
    // return null;
    // }
    ...
    // @Override
    // public MiddlewareStatus pivGenerateKeyPair(CardHandle cardHandle, byte
    // keyReference, byte cryptographicMechanism, PIVDataObject publicKey) {
    // return null;
    // }
}
